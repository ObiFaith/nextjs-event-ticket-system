...
import { ShoppingCart, Trash2, Clock, Minus, Plus, Info } from 'lucide-react';
import { toast } from 'sonner';

export const Cart = () => {
  const navigate = useNavigate();
  const { cart, updateCartQuantity, removeFromCart, clearCart, cartExpiry } = useApp();
        ...
        <main className="container mx-auto px-4 py-8">
          <Card className="shadow-sm max-w-2xl mx-auto">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <Button onClick={() => navigate('/dashboard')}>Browse Events</Button>
            </CardContent>
          </Card>
        </main>
        <MobileBottomNav />
          ...
          {cartExpiry && (
            <Alert className="mb-6 border-accent/50 bg-accent/10">
              ...
              <AlertDescription className="text-accent-foreground/90">
                Your reservation expires in <span className="font-semibold">{timeLeft}</span> minutes
              </AlertDescription>
            </Alert>
          )}
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will remove the ticket from your cart and release the reservation.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
            ...
            <CardContent className="space-y-4">
              ...
              <Alert className="border-blue-200 bg-blue-50">
                ...
                <AlertDescription className="text-blue-900 text-sm">
                  Tickets are reserved temporarily. No payment is required for this demo.
                </AlertDescription>
              </Alert>
